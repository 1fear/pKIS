...
| **Заявка SkladBot** | Внешняя WMS-заявка | request_id, номер, получатель, тип `Отгрузка 3PL`, created_at, unloading_date, адрес, товары, raw | сопоставляется с группой | Обогащает заказ номером; не блокирует скан |
...
| SkladBot не находит номера | Средний (ручная правка) | Средняя | Окно 14 дн., строгий клиент, диагностика, partial-match |
